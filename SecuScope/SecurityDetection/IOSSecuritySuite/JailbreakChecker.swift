...
internal class JailbreakChecker {
  ...
  static func checkExistenceOfSuspiciousFiles() -> CheckResult {
    var paths = [
      ...
      "/var/mobile/Library/Saved Application State/cn.gblw.AppsDump.savedState", // root-hide AppsDump
      "/var/mobile/Library/Saved Application State/ws.hbang.Terminal.savedState", // root-hide Terminal
      "/var/mobile/Library/Saved Application State/org.coolstar.SileoStore.savedState", // root-hide Sileo
      "/var/mobile/Library/Saved Application State/xyz.willy.Zebra.savedState", // root-hide Zebra
      "/var/mobile/Library/SplashBoard/Snapshots/org.coolstar.SileoStore", // root-hide Sileo
      "/var/mobile/Library/SplashBoard/Snapshots/xyz.willy.Zebra", // root-hide Zebra
      "/var/mobile/Library/SplashBoard/Snapshots/cn.gblw.AppsDump", // root-hide AppsDump
      "/var/mobile/Library/SplashBoard/Snapshots/ws.hbang.Terminal", // root-hide Terminal
      "/var/mobile/Documents/DumpIpa", // root-hide AppsDump
      "/var/root/Library/Caches/com.opa334.Dopamine-roothide", // Dopamine
      "/var/root/Library/Caches/shshd" // Dopamine
    ]
